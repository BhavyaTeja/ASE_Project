...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://foodapp-47000.firebaseio.com/"),
    refCart = new Firebase("https://foodapp-47000.firebaseio.com/cart"),
    refUser = new Firebase("https://foodapp-47000.firebaseio.com/users"),
    refCategory = new Firebase("https://foodapp-47000.firebaseio.com/category"),
    refOrder = new Firebase("https://foodapp-47000.firebaseio.com/orders"),
    refFeatured = new Firebase("https://foodapp-47000.firebaseio.com/featured"),
    refMenu = new Firebase("https://foodapp-47000.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
